            ...
            while(options != 10) {
                ...
                switch (options) {
                    ...
                    case 2:
                        ...
                        System.out.printf(displayFormat, "GroupName","HeadWriter","YearFormed","Subject", "BookTitle", "PublisherName", "YearPublished", "NumberPages", 
                        ...
                        while (rs.next()) {
                            ...
                            System.out.printf(displayFormat,
                                    ...
                                    dispNull(name), dispNull(writer), dispNull(year), dispNull(sub), dispNull(title), dispNull(pName), dispNull(pYear), dispNull(pages),

                                    dispNull(address), dispNull(phone), dispNull(email));
